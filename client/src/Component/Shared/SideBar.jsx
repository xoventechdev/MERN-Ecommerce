  ...
  return (
    ...
    >
      ...
      <ul className="menu-inner py-1 ps ps--active-y">
          ...
          <ul className="menu-sub">
            <li className="menu-item">
              <a href="layouts-collapsed-menu.html" className="menu-link">
                <div className="text-truncate" data-i18n="Collapsed menu">
                  Collapsed menu
                </div>
              </a>
            </li>
            <li className="menu-item">
              <a href="layouts-content-navbar.html" className="menu-link">
                <div className="text-truncate" data-i18n="Content navbar">
                  Content navbar
                </div>
              </a>
            </li>
            ...
            <li className="menu-item">
              <a
                ...
                target="_blank"
              >
                <div className="text-truncate" data-i18n="Horizontal">
                  Horizontal
                </div>
              </a>
            </li>
        ...
        <div className="ps__rail-x" style={{ left: 0, bottom: "-243px" }}>
          <div
        ...
        <div className="ps__rail-y" style={{ top: 243, height: 290, right: 4 }}>
          <div
            className="ps__thumb-y"
            tabIndex={0}
            style={{ top: 32, height: 38 }}
          />
        </div>
      </ul>
    </aside>
